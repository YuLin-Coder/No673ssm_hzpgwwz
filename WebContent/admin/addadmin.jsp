...
<body>
	<div style="margin: 15px;">
		...
		<form id="addForm" class="layui-form" action="admin/addAdmin.action" name="myform" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="realname" class="layui-input" id="realname" placeholder="请输入姓名" />
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">联系方式</label>
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="contact" class="layui-input" id="contact" placeholder="请输入联系方式" />
				</div>
			</div>
