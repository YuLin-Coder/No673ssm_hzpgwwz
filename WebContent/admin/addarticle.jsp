...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
			<legend>新增商城公告信息</legend>
		</fieldset>
		<form id="addForm" class="layui-form" action="article/addArticle.action" name="myform" method="post">
			<div class="layui-form-item">
				<label class="layui-form-label">标题</label>
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="title" class="layui-input" id="title" placeholder="请输入标题" />
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 45%;">
					...
					<textarea name="contents" id="contents" placeholder="请输入内容"> </textarea>
