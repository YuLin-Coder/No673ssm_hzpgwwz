...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
			<legend>新增商品类型信息</legend>
		</fieldset>
		<form id="addForm" class="layui-form" action="cate/addCate.action" name="myform" method="post">
			<div class="layui-form-item">
				<label class="layui-form-label">类型名称</label>
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="catename" class="layui-input" id="catename" placeholder="请输入类型名称" />
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">备注</label>
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="memo" class="layui-input" id="memo" placeholder="请输入备注" />
				</div>
			</div>
